...
s_name = sprintf('LP_CntCur_%4d%03d.dat', s_time(1), date2doy(s_time));
e_name = sprintf('LP_CntCur_%4d%03d.dat', e_time(1), date2doy(e_time));

spikelog = [];
filepath = '../../Cassini_LP_DATA_Archive/Cnt_CurDat/';
